...
export class Titan extends ethereum.SmartContract {
  static bind(address: Address): Titan {
    return new Titan("Titan", address);
  }

  BULKTRANSFER_ROLE(): Bytes {
    let result = super.call(
      "BULKTRANSFER_ROLE",
      "BULKTRANSFER_ROLE():(bytes32)",
      []
    );
  ...
  try_BULKTRANSFER_ROLE(): ethereum.CallResult<Bytes> {
  ...
  ENABLETRANSFER_ROLE(): Bytes {
    let result = super.call(
      "ENABLETRANSFER_ROLE",
      "ENABLETRANSFER_ROLE():(bytes32)",
      []
    );
  ...
  try_ENABLETRANSFER_ROLE(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "ENABLETRANSFER_ROLE",
      "ENABLETRANSFER_ROLE():(bytes32)",
      []
